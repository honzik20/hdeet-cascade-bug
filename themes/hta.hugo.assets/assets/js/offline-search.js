...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        /*
            Ajax call above will fail when running from local filesystem (CORS violation).
            This is where we fork from /themes/docsy/assets/offline-search.js
        */       
            ...
            const results = idx
                .query((q) => {
                    ...
                    tokens.forEach((token) => {
                        ...
                        /*Enabling this makes the search too fuzzy - removed. Bug#116645
                        */
                        // q.term(queryString, {
                        //     editDistance: 2,
                        // });
